...
// the database and build database tables bases on our data model
...
namespace VirtualPetAdoption.Data
{
    public class PetAdoptionContext : DbContext
    {
        ...
        // Special method that when it's called, creates
        ...
        //Method for building a new data model for each pet and populating it with data
